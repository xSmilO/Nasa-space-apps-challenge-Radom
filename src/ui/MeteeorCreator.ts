...
export default class MeteorCreator {
    ...
    constructor(ui: UI) {
        ...
        this.label = document.querySelector<HTMLElement>("#meteorName") as HTMLElement;
        this.leftArrow = document.querySelector<HTMLDivElement>(".left-arrow") as HTMLDivElement;
        this.rightArrow = document.querySelector<HTMLDivElement>(".right-arrow") as HTMLDivElement;
    ...
    private changePreset(delta: number): void {
      ...
      if(MeteorCreator.asteroidPreset >= MeteorCreator.asteroidPresets.length) {
        MeteorCreator.asteroidPreset = 0;
      }

      if(MeteorCreator.asteroidPreset < 0) {
        MeteorCreator.asteroidPreset = MeteorCreator.asteroidPresets.length - 1;
      }
      ...
      (this.diameterInput as HTMLInputElement).value = asteroidPreset.diameter.toPrecision();
      (this.densityInput as HTMLInputElement).value = asteroidPreset.density.toPrecision();
      (this.angleInput as HTMLInputElement).value = asteroidPreset.angle.toPrecision();
      (this.velocityInput as HTMLInputElement).value = asteroidPreset.velocity.toPrecision();
    }
